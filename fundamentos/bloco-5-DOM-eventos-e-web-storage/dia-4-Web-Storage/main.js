...
let corFundo = document.getElementById("tela");
corFundo.style.backgroundColor = 'aquamarine';
let inputCaixa = document.querySelector('#caixa-texto');

function corBackground () {
    corFundo.style.backgroundColor = inputCaixa.value;
}

inputCaixa.addEventListener('keyup', corBackground);
